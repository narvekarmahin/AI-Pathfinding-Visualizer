...
(A-Star) Search Algorithm: A highly efficient pathfinding algorithm that uses a heuristic (Manhattan distance) to guide its search towards the target, minimizing the number of nodes evaluated.
